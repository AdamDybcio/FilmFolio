          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                ...
                const Header(title: 'Overview', delay: Duration(milliseconds: 1500)),
                MovieOverview(movie: movie),
                SizedBox(height: MediaQuery.of(context).size.height * 0.05),
                const Header(title: 'Movie Details', delay: Duration(seconds: 1)),
                const MovieDetails(),
                SizedBox(height: MediaQuery.of(context).size.height * 0.05),
                const Header(title: 'Cast', delay: Duration(milliseconds: 2000)),
